              ...
              <div className="OrderPlacement-orderSummary-content-row-os">
                ...
                <div className="mobile-content-os">
                  ...
                  <div className="OrderPlacement-paymentInfo-submit-buttons-row-os">
                    ...
                    >
                      {isTotalAmountZero > 0 ? "Pay now" : "Pay now"}
                    </button>
                  </div>
                </div>
                ...
                <div className="OrderPlacement-orderSummary-content-col-1-os">
                  ...
                  {/* <div className="OrderPlacement-orderSummary-content-next-button-os">
                  <button
                    type="button"
                    onClick={() => {
                      if (
                        ...
                        setError("Please complete the field above");
                      }
                    }}
                    className="OrderPlacement-paymentInfo-submit-button-os"
                  >
                    {isTotalAmountZero > 0 ? "Pay now" : "Place Order"}
                  </button>
                </div> */}
                </div>
              </div>
              ...
              <div className="OrderPlacement-paymentInfo-submit-buttons-row-os">
                ...
                onClick={() => {
                  ...
                  if (isTotalAmountZero > 0) {
                    ...
                    localStorage.setItem("vipthankyou", true);
                    Navigate("/thank-you?count=" + cartItems?.length);
                    setCartItems([]);
                  }
                }}
                className="OrderPlacement-paymentInfo-submit-button-os tablet-content-os"
              >
                {isTotalAmountZero > 0 ? "Next" : "Place Order"}
              </button> */}
                <button
                  type="button"
                  // onClick={() => {
