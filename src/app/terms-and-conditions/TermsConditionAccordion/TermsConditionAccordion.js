        ...
        <div className="tab">
          ...
          >
            ...
            <p>
              ...
              customer’s VNS wallet. Later, the customer can either use this
              wallet amount to order another VIP number or can withdraw to their
              bank account via PayTM, Google Pay, UPI, bank account transfer, or
              any other compatible medium. Released payment will be processed
              within 48 working hours from the requested date & time.
            </p>
            <p>
        ...
        <div className="tab">
          ...
          >
            ...
            <p>
              ...
              email, and the customer doesn’t send an MNP request or face any
              issue related to MNP. THEY MUST CONTACT US WITHIN THE 20 DAYS.
            </p>
            <p>
      ...
      <div className="row-os">
        <div className="tab">
          ...
          >
            ...
            <p>
              The customer can contact us by calling on 70091-70092 or directly
              contact his assigned account manager.
            </p>
            <p>
              Customers can also contact us via email at info@vipnumbershop.com.
            </p>
            <p>
