...
const WhyChooseVipNumberShop = () => {
  // const startYear = 2008; // Change this to the year the company was founded
  ...
  return (
    <section className="WhyChooseVipNumberShop-section-os">
      <div className="container-os">
        ...
        <div className="WhyChooseVipNumberShop-row-os">
