...
import { CityMadhyaPradeshFaqs } from "../CityFaqsArray/CityFaqsArray";
  ...
  return (
    <div className="city-page-os">
      <Helmet>
        ...
        <link rel="canonical" href="https:// https://vipnumbershop.com/vip-mobile-number-in-madhya-pradesh" />
      </Helmet>
      <Header />
      <MobileHeader />
      <CityBanner
