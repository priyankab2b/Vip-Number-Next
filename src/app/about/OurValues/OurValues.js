...
// Images
import MainImg from "../../Assets/value-mob-img.png";
    ...
    <section className="OurValues-section-os">
      <div className="container-os">
        <div className="our-values-title">
          <h1>Our Values</h1>
          <p>
            At VIP Number Shop (VNS), we work with values. It's our values that
            further helps us in providing our customers 100% satisfaction.
