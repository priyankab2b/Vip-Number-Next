...
const FilterTabs = ({ selectedFilter, setSelectedFilter, id }) => {
    ...
    const applyFilters = () => {
        ...
        if (checkedItems) {
            if (checkedItems?.basic && checkedItems?.premium) filterObj["seller"] = "BASIC,PREMIUM";
        ...
        //     : "PREMIUM";
        // if (total) filterObj["total"] = total;
        // if (sum) filterObj["sum"] = sum;
        if (total)
                        ...
                        <div className="multiple-filters-tabs-data-row-os">
                            ...
                            <div className="multiple-filters-tabs-data-col-2-os">
                                ...
                                >
                                    <div className="multiple-filters-checkbox-col-1-os">
                                        <label
                                            className={`multiple-filters-checkbox-os ${queryParams?.type === "advanced" ||
                                                    queryParams?.searchBy === "price" ||
                                                    queryParams?.type === "global" ||
                                                    queryParams?.type === "basic" ||
                                                    queryParams?.type === "exactPlacement" ||
                                        ...
                                        >
                                            ...
                                            <input
                                                type="checkbox"
                                                name="premium"
                                                defaultChecked={checkedItems.premium}
