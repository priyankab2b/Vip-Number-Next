    ...
    return (
        <div className="PurchaseNumberCard-os">
            <div className="PurchaseNumberCard-col-os">
                ...
                <p>
                    {props.subText}
                    {props.star && <span style={{ color: "red", fontSize: "20px", fontWeight: "700" }}>{props.star}</span>}
                    {props.spanText && <span style={{ fontSize: "12px", fontWeight: "700" }}>{props.spanText}</span>}
                </p>
            </div>
        </div>
    );
