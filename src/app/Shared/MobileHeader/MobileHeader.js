...
const MobileHeader = () => {
  ...
  const HandleSearchIcon = () => {
    ...
    if (window.Pathname.pathname !== "/") {
      Router.push("/");
      console.log("Current Path:", window.Pathname.pathname);
    } else {
      window.scrollTo({
              ...
              <div className="MobileHeader-sideNavbar-main-col-1-os">
                ...
                <div className="MobileHeader-sideNavbar-links-main-row-os">
                  ...
                  <ul className="MobileHeader-sideNavbar-link-list-os">
                    <li>
                      <Link href="/" onClick={mobileToggleInactive}>
                        <span>
                    ...
                    <li>
                      <Link href="/about" onClick={mobileToggleInactive}>
                        <span>
                    ...
                    >
                      ...
                      >
                        <li>
                          <Link href="/faq" onClick={mobileToggleInactive}>
                            FAQs
                          </Link>
                        </li>
                        <li>
